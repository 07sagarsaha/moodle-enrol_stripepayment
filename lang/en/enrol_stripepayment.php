...
$string['privacy:metadata:enrol_stripepayment:receiveremail'] = 'The email address of the user who receives the payment.';
$string['privacy:metadata:enrol_stripepayment:receiverid'] = 'The ID of the user who receives the payment.';
