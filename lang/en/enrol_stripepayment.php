...
$string['error_invalid_publishable_key_format'] = 'Publishable key format is incorrect for {$a} mode.';
$string['error_invalid_secret_key_format'] = 'Secret key format is incorrect for {$a} mode.';
$string['error_missing_publishable_key'] = 'Publishable key is missing for {$a} mode.';
$string['error_missing_secret_key'] = 'Secret key is missing for {$a} mode.';
...
$string['invalidjson'] = 'Invalid JSON response from Stripe';
...
$string['statusconfigerror'] = '{$a} MODE - Configuration Error';
...
$string['stripeconfigincomplete'] = 'Stripe configuration incomplete';
$string['stripeconfigurationincomplete'] = 'Stripe configuration incomplete';
$string['stripecreatecustomerfailed'] = 'Could not create customer in Stripe: {$a}';
...
$string['stripepaymenterroroccurred'] = 'Stripe payment error occurred';
...
$string['validationfailed'] = 'Validation failed: {$a}';
